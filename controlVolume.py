...
class ControlVolume:
    def __init__(self, mDotIn, mDotDiff, xIn):
        self.mDotIn = mDotIn
...
if __name__=="__main__":
    ...
    controlVolume = ControlVolume(mDotIn, mDotDiff, xIn)
